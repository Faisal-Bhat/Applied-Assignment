...
export const colorStyles = makeStyles(({ palette, ...theme }) => ({
  "@global": {
    ...
    ".bg-sky": { background: "#42f2f5 !important", color: "inherit" },
    ".bg-skin": { background: "#f56342 !important", color: "inherit" },
    ".bg-navy": { background: "#000080 !important", color: "inherit" },
    ".bg-blue": { background: "#0000FF !important", color: "inherit" },
    ".bg-teal": { background: "#008080 !important", color: "inherit" },
    ".bg-purple": { background: "#800080 !important", color: "inherit" },

    ".bg-yellow": { background: "#fa7000 !important", color: "inherit" },
    ...
    ".text-light-white": { color: "rgba(107, 106, 104, 0.7) !important" },
